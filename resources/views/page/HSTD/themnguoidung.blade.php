	...
	<div class="row">
		<div class="col-md-6 ">
				<form class="form-horizontal" action="themhs" method="POST">
					...
					<div class="form-group">
						<label class="col-xs-3 control-label">Ngày Sinh</label>
				        <div class="col-xs-5">
				            <input type="date" class="form-control" name="NgaySinh" />
				        </div>
					</div>
					<div class="form-group">
						<label class="col-xs-3 control-label">Nơi Sinh</label>
				        <div class="col-xs-5">
				            <input type="text" class="form-control" name="NoiSinh" />
				        </div>
					</div>
					<div class="form-group">
						<label class="col-xs-3 control-label">CMND</label>
				        <div class="col-xs-5">
				            <input type="text" class="form-control" name="CMND" />
				        </div>
					</div>
					<div class="form-group">
						<label class="col-xs-3 control-label">Ngày Cấp</label>
				        <div class="col-xs-5">
				            <input type="date" class="form-control" name="NgayCap" />
				        </div>
					</div>
					<div class="form-group">
						<label class="col-xs-3 control-label">Nơi Cấp</label>
				        <div class="col-xs-5">
					...
					<div class="form-group">
						<label class="col-xs-3 control-label">Dân Tộc</label>
				        <div class="col-xs-5">
				            <input type="text" class="form-control" name="DanToc" />
				        </div>
					</div>
					<div class="form-group">
						<label class="col-xs-3 control-label">Quốc Tịch</label>
				        <div class="col-xs-5">
				            <input type="text" class="form-control" name="QuocTich" />
				        </div>
					</div>	
					<div class="form-group">
						<label class="col-xs-3 control-label">TT Hôn Nhân</label>
				        <div class="col-xs-5">
				            <input type="text" class="form-control" name="TTHonNhan" />
				        </div>
					</div>
					<div class="form-group">
						<label class="col-xs-3 control-label">Quê Quán</label>
				        <div class="col-xs-5">
					...
					<div class="form-group">
						<label class="col-xs-3 control-label">Nơi Ở HT</label>
				        <div class="col-xs-5">
				            <input type="text" class="form-control" name="NoiOHienTai" />
				        </div>
					</div>
					<div class="form-group">
						<label class="col-xs-3 control-label">SDT</label>
				        <div class="col-xs-5">
					...
					<div class="form-group">
						<label class="col-xs-3 control-label">Năng Khiếu</label>
				        <div class="col-xs-5">
				            <input type="text" class="form-control" name="NangKhieu" />
				        </div>
					</div>
					<div class="form-group">
						<label class="col-xs-3 control-label">Sức Khỏe</label>
				        <div class="col-xs-5">
				            <input type="text" class="form-control" name="SucKhoe" />
				        </div>
					</div>
					<div class="form-group">
						<label class="col-xs-3 control-label">Ngày Tuyển Dụng</label>
				        <div class="col-xs-5">
				            <input type="date" class="form-control" name="NgayTuyenDung" />
				        </div>
					</div>
					<div class="form-group">
						<label class="col-xs-3 control-label">Cơ quan Tuyển Dụng</label>
				        <div class="col-xs-5">
				            <input type="text" class="form-control" name="CoQuanTuyenDung" />
				        </div>
					</div>
					<div class="form-group">
						<label class="col-xs-3 control-label">Trình Độ Học Vấn</label>
				        <div class="col-xs-5">
				            <input type="text" class="form-control" name="TDHocVan" />
				        </div>
					</div>
					<div class="form-group">
						<label class="col-xs-3 control-label">Kinh Nghiệm</label>
				        <div class="col-xs-5">
